...
docker run --name app-go -p 4001:4001 -d --network live-discussion-app mprambadi/app-go  
docker run --name app-php -p 4002:4002 -d --network live-discussion-app mprambadi/app-php  
